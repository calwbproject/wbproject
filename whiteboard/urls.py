...
urlpatterns = [
    ...
    path('sales_info/', views.Sales_info.as_view(), name='sales_info'),
    path('load_overview/', views.Load_overview.as_view(), name='load_overview'),
    path('load_detail/<int:pk>', views.Load_details.as_view(), name='load_detail'),
]